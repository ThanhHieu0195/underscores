...
function gfblock_enqueue_block_title_editor_assets() {
	// Scripts.
	wp_enqueue_script(
...
add_action( 'enqueue_block_editor_assets', 'gfblock_enqueue_block_title_editor_assets' );
 ...
 * @since 1.0.0
 */
function gfblock_enqueue_block_title_assets() {
	wp_enqueue_style(
...
add_action( 'enqueue_block_assets', 'gfblock_enqueue_block_title_assets' );